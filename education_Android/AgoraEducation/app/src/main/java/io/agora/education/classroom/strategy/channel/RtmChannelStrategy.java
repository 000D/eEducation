...
public class RtmChannelStrategy extends ChannelStrategy<List<RtmChannelAttribute>> {
    ...
    @Override
    public void queryOnlineStudentNum(@NonNull ResultCallback<Integer> callback) {
        ...
        if (students.size() == 0) {
            ...
            RtmManager.instance().queryPeersOnlineStatus(set, new ResultCallback<Map<String, Boolean>>() {
                @Override
    ...
    @Override
    public void queryChannelInfo(@Nullable ResultCallback<Void> callback) {
        RtmManager.instance().getChannelAttributes(getChannelId(), new ResultCallback<List<RtmChannelAttribute>>() {
            @Override
    ...
    @Override
    public void updateLocalAttribute(Student local, @Nullable ResultCallback<Void> callback) {
    ...
    @Override
    public void clearLocalAttribute(@Nullable ResultCallback<Void> callback) {
    ...
    private RtmEventListener rtmEventListener = new RtmEventListener() {
        ...
        public void onJoinChannelSuccess(String channel) {
            queryChannelInfo(new ResultCallback<Void>() {
                @Override
