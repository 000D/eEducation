...
public class NetlessAPI {
    ...
    public static void createRoom(String name, Callback callback) {
        ...
        NetworkManager.getInstance().postRequest(url, body, new NetworkManager.CallBack() {
            @Override
    ...
    public static void getRoom(String uuid, Callback callback) {
